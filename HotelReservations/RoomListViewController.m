...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
  ...
  if (self.isNewBooking) {
    ...
    Room* room = [CoreDataStack sharedInstance].savedRooms[MIN(indexPath.row, [CoreDataStack sharedInstance].savedRooms.count - 1)];  // MIN due to switching backing array race
